...
console.log("Sort the array employees in ascending order ID, Name & Department");
...
console.log("Sort the array employees in ascending order ID, Department & Company");
arrayOfEmployees.sort((emp1,emp2) => {
...
console.log("Sort the array employees in descending order Name, Salary & Company");
arrayOfEmployees.sort((emp1,emp2) => {
